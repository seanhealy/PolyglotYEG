      ...
      function(require, module, exports) {
        ...
        angular.module("Polyglot").directive("pgWheat", function() {
          return {
            ...
            controller: function($scope, $window) {
              ...
              for (
                stockNumber = _i = 0;
                0 <= stockCount ? _i <= stockCount : _i >= stockCount;
                stockNumber = 0 <= stockCount ? ++_i : --_i
              ) {
                ...
                _results.push(
                  $scope.stocks.push({
                    margin: "0 " + margin + "px",
                    transform:
                      "rotate(" + tilt + "deg) translateY(" + offset + "px)"
                  })
                );
              }
              return _results;
        ...
        angular.module("Polyglot").directive("pgTickets", function() {
          return {
            ...
            replace: true,
            template:
              '<center>\n  <a class="button" href="https://polyglot-yeg-2020.eventbrite.ca/">Get Tickets</a>\n</center>'
